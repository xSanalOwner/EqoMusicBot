...
'''
        ...
        for i in range(len(dur_arr)-1, -1, -1):
            ...
            secmul *= 60
        m.edit("📤 Yüklənir..")
        message.reply_audio(audio_file, caption=caption_for_private, quote=False, title=title, duration=dur, thumb=thumb_name, performer = f"PasterMusicBot", reply_markup=buttons['markup_for_private'])
        m.delete()
